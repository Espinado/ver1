                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title"> {{ __('system.confirmed_orders') }}</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">{{$order->invoice_no}}</td>
                                                 <td style="text-align: center">{{$order->amount}}&nbsp;EUR</td>
                                                  ...
                                                  <td style="text-align: center"><span class="badge badge-pill badge-warning">{{__('system.' . App\Enums\OrderStatus::getKey($order->status))}}</span></td>
