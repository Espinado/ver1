...
<nav class="breadcrumb sl-breadcrumb">
    <a class="breadcrumb-item" href="{{ LaravelLocalization::localizeUrl('/admin/') }}">{{ __('system.dashboard') }}</a>
...
<div class="content_wrapper">
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        <a href="{{ LaravelLocalization::localizeUrl('/admin/') }}" class="sl-menu-link active">
