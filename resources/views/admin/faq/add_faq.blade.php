        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">{{ __('system.add_faq') }} </h4>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="POST" action="{{ route('admin.store.faq') }}">
                                @csrf
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="question[{{ $key }}]"
                                                        class="form-control" value="{{ old('question.' . $key) }}">
                                                    @error("question.{$key}")
                    ...
                    <div class="text-xs-right">
                        <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Add faq" title="Add blog">
                    </div>
                    </form>
