...
<div class="content_wrapper">
                ...
                <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> {{Auth::guard('seller')->user()->seller_company->seller_company_name}}
    {{ Config::get('company_legal_status.legal_status.' .Auth::guard('seller')->user()->seller_company->seller_company_profile->seller_company_legal_country .'.status.' .Auth::guard('seller')->user()->seller_company->seller_company_legal_status) }}</a></div>
                    ...
                    <div class="card widget-messages mg-t-20">
                      ...
                      <div class="list-group list-group-flush">
                        <a href="" class="list-group-item list-group-item-action media">
                          <img src="{{asset('panel/img/img10.jpg')}}" alt="">
                        ...
                        <a href="" class="list-group-item list-group-item-action media">
                          <img src="{{asset('panel/img/img9.jpg')}}" alt="">
                          <div class="media-body">
                            <div class="msg-top">
                        ...
                        <a href="" class="list-group-item list-group-item-action media">
                          <img src="{{asset('panel/img/img8.jpg')}}" alt="">
                          <div class="media-body">
                            <div class="msg-top">
                        ...
                        <a href="" class="list-group-item list-group-item-action media">
                          <img src="{{asset('panel/img/img7.jpg')}}" alt="">
                          <div class="media-body">
                            <div class="msg-top">
